...
export default function Product({name,image,description,price}){
    ...
    return(
        ...
        <div className="bg-neutral-200 p-4 rounded shadow-md flex flex-col justify-between">
            ...
            <div className="w-full">
                ...
                <button className="w-full text-white py-2 px-4 rounded-md bg-neutral-900">
                    More info
